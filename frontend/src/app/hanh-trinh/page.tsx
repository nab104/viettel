  ...
  return (
    <div className="min-h-screen flex flex-col font-sans bg-white pt-24 overflow-x-hidden">
      ...
      <section className="py-24 bg-gray-50">
        <div className="container mx-auto px-6 max-w-7xl">
           <h2 className="text-[#EE0033] font-black text-6xl md:text-8xl uppercase mb-72 tracking-tighter opacity-40 leading-none">THÀNH TỰU</h2>
           
           <div className="bg-white rounded-[3rem] shadow-2xl p-12 md:p-20 flex flex-col md:flex-row items-center gap-16 relative -mt-64">
