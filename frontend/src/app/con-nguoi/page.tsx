...
const departments = [
...

  {
    ...
    img: "/images/phong-ban-moi/dept-13.png",
    hasTextOnImage: true,
    details: {
      leader: { name: "Đang cập nhật...", role: "Trưởng phòng", img: "/images/logo-viettel-store.png" },
      group: { name: "Đảng bộ bộ phận và các Chi bộ", subName: "Viettel Store", img: "/images/phong-ban-moi/dept-13.png" },
      deputies: []
    }
  },
  {
      ...
      <>
        {selectedDept && (
          <div className="fixed inset-0 z-[2147483647] bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 md:p-10 animate-in fade-in duration-300">
            ...
            <button onClick={() => setSelectedDept(null)} className="fixed top-6 right-6 md:top-10 md:right-10 text-white/70 hover:text-white z-50 p-2 bg-white/10 hover:bg-white/20 rounded-full cursor-pointer transition-all">
            ...
            <div className="relative w-full max-w-[95vw] flex flex-col items-center">
              ...
              <div className={`w-full flex flex-col md:flex-row md:items-stretch justify-center ${popupConfig.gap} px-4 md:px-10`}>
              ...
              <div className="flex gap-12 mt-16">
                <button
                  onClick={(e) => {
                    e.stopPropagation();
                    const currentIndex = departments.findIndex(d => d.name === selectedDept.name);
